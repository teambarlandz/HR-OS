...
/// linker script.
/// RISC-V DTIM shares 8K with data/bss, so EXEC_BUFFER is 1K there;
/// ARM SRAM carve affords the full 4K.
#[cfg(target_arch = "riscv32")]
pub const EXEC_BUFFER_SIZE: usize = 768; // DTIM carve leaves room for scratch region
