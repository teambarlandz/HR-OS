...
pub mod memory {
    ...
    #[inline(always)]
    pub fn poke_u32(addr: usize, val: u32) {
        unsafe { core::ptr::write_volatile(addr as *mut u32, val) }
    }
    pub fn reg_set_bit(addr: usize, bit: u8) {
        let v = peek_u32(addr) | (1u32 << bit);
        poke_u32(addr, v)
    }
...
pub mod exec {
    ...
    #[repr(C, align(4))]
    pub struct ExecBuffer(pub [u8; 4096]);
    #[link_section = ".sram_code"]
    pub static mut EXEC_BUFFER: ExecBuffer = ExecBuffer([0; 4096]);
...
pub mod interrupt {
    ...
    pub struct VectorTable {
        ...
        pub handlers: [Option<unsafe extern "C" fn()>; 32],
    }
